...
#Voting Data
```{r, echo=FALSE}
libertarian <- read.csv("/Users/erin/Desktop/state_collectivism/libertarian/libertrarian_election.csv")
...
```{r, echo=FALSE}
mergefinal <- read.csv("/Users/erin/Desktop/state_collectivism/state_index.csv")
...
write.csv(data_all, "/Users/erin/Desktop/state_collectivism/state_collectivism_score_all.csv")
...
- mean V-C score is 31.8, the mean of new collectivism score is 39.5
- The correlation between the new state-level score and the V-C score is 0.688175, t = 6.5714, df = 48, p-value = 3.342e-08
- The correlation between old and new rankings is 0.7625516, t = 8.1665, df = 48, p-value = 1.235e-10
...
mean(comparedata$state_collectivism_score) #39.49071
